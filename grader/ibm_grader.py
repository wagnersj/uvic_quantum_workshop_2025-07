...
def grader_lab1ex1(result: PrimitiveResult):
...
def grader_lab1ex2a(circuit: QuantumCircuit):
...
def grader_lab1ex2b(result: PrimitiveResult):
...
def grader_lab2ex1a(circuit: QuantumCircuit):
...
def grader_lab2ex1b(circuit: QuantumCircuit):
...
def grader_lab2ex1c(result: PrimitiveResult):
...
def grader_lab2ex2(result: PrimitiveResult):
...
def grader_lab3ex1a(qc: QuantumCircuit):
...
def grader_lab3ex1b(qc: QuantumCircuit):
...
def grader_lab3ex2a(layers: list[list]):
...
def grader_lab3ex2b(qc_t: QuantumCircuit):
...
def grader_lab3ex3(qc_t: QuantumCircuit, backend: IBMBackend):
